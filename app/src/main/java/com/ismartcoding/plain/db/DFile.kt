...
interface FileDao {
    ...
    fun insert(file: DFile): Long

    @Query("SELECT * FROM files WHERE id = :id")
    fun getById(id: String): DFile?
    ...
    fun findByWeakKey(size: Long, weakHash: String): List<DFile>
    ...
    fun getOrphans(): List<DFile>

    @Query("DELETE FROM files WHERE id = :id")
    fun delete(id: String)

    @Update
    fun update(file: DFile)
}
